                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                ProfileDataHeadingLabel(label: 'Name'),
                                ProfileUserDetailsLabel(
                                    details:
                                        '${userDataHandler.userData.name}'),
                                ProfileDataHeadingLabel(label: 'Surname'),
                                ProfileUserDetailsLabel(
                                    details:
                                        '${userDataHandler.userData.surname}'),
                                ProfileDataHeadingLabel(label: 'ID Number'),
                                ProfileUserDetailsLabel(
                                    details:
                                        '${userDataHandler.userData.idNum}'),
                                ProfileDataHeadingLabel(
                                    label: 'Contact Number'),
                                ProfileUserDetailsLabel(
                                    details:
                                        '${userDataHandler.userData.contactNum}'),
                                ProfileDataHeadingLabel(label: 'Email'),
                                ProfileUserDetailsLabel(
                                    details:
                                        '${userDataHandler.userData.email}'),
                              ],
                            ),
                          ),
                        ),
